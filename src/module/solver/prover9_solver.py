...
# 2. Lùi lại 3 cấp để về thư mục gốc TestSymbolicReasoning
# (solver -> module -> src -> TestSymbolicReasoning)
project_root = os.path.abspath(os.path.join(current_dir, '..', '..', '..'))

# 3. Nối với thư mục LADR-2009-11A/bin
dynamic_prover9_path = os.path.join(project_root, 'LADR-2009-11A', 'bin')
# dynamic_prover9_path = os.path.join(project_root, 'Prover9-Mace4','bin-win32')
# 4. Gán cho NLTK
os.environ['PROVER9'] = dynamic_prover9_path

print(f"[DEBUG] Đã nạp Prover9 tại đường dẫn: {os.environ['PROVER9']}")
